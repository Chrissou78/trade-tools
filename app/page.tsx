...
export default function Home() {
  return (
    <div className="max-w-4xl mx-auto py-16 px-6">
      ...
      <h2 className="text-sm font-medium text-zinc-400 mb-3 uppercase tracking-wide">MVP</h2>
      <div className="grid grid-cols-2 gap-4 mb-10">
        <Link href="/launch" className="border rounded-lg p-4 hover:border-black dark:hover:border-white transition">
          <div className="font-medium">Launch Buyer</div>
          <div className="text-sm text-zinc-500">Generate wallets, simulate 2% supply per wallet, fund, buy, and sell per wallet</div>
        </Link>
        <Link href="/scanner" className="border rounded-lg p-4 hover:border-black dark:hover:border-white transition">
      ...
      <h2 className="text-sm font-medium text-zinc-400 mb-3 uppercase tracking-wide">Other Tools</h2>
